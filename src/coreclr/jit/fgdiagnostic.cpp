...
void Compiler::fgDumpLoopsToFlowGraph(FILE* file)
{
    class Dumper
    {
    ...
    public:
        ...
        void Output(FlowGraphNaturalLoop* loop)
        {
            ...
            loop->VisitLoopBlocksReversePostOrder([=](BasicBlock* block) {
                ...
                {
                    FlowGraphNaturalLoop* childLoop = m_loops->GetLoopFromHeader(block);
...
//                for (FlowGraphNaturalLoop* loop : m_loops->InReversePostOrder())
//                {
//                    sprintf_s(name, sizeof(name), FMT_LP " (old: " FMT_LP ")", loop->GetIndex(), loopNum);
//
//                }
...
//                //    }
//
//                //    sprintf_s(name, sizeof(name), FMT_LP " (old: " FMT_LP ")", m_oldToNewLoop[loopNum]->GetIndex(), loopNum);
//
//                //    if (displayLoopFlags)
//                //    {
...
//            }
            ...
            if (includeLoops && (m_loops != nullptr))
            {
                fgDumpLoopsToFlowGraph(fgxFile);
            }
        }
    }
