...
{
    GenTree* first = m_stmt->GetTreeList()->gtNext;
...
GenTree** LocalsGenTreeList::GetForwardEdge(GenTreeLclVarCommon* node)
{
    ...
    {
        assert(m_stmt->GetTreeList()->gtNext == node);
        return &m_stmt->GetTreeList()->gtNext;
    }
    else
    {
...
GenTree** LocalsGenTreeList::GetBackwardEdge(GenTreeLclVarCommon* node)
{
    ...
    {
        assert(m_stmt->GetTreeList()->gtPrev == node);
        return &m_stmt->GetTreeList()->gtPrev;
    }
    else
    {
